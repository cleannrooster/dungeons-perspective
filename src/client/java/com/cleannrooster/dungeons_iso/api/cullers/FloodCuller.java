...
public class FloodCuller implements BlockCuller {
    ...
    public boolean shouldCull(BlockPos blockPos, Camera camera, Entity cameraEntity) {
        return cameraEntity != null && Mod.shouldReload && cameraEntity.getWorld().getBlockState(blockPos).getMainCameraCollisionShape(cameraEntity.getWorld(), blockPos, CollisionContext.of(cameraEntity)).isEmpty();
    }
