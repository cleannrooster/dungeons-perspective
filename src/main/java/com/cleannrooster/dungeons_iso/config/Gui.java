                            ...
                            .category(ConfigCategory
                                    ...
                                    .group(OptionGroup.createBuilder()
                                            ...
                                            .option(Option
                                                    ...
                                                    .controller(floatOption -> new FloatSliderControllerBuilderImpl(floatOption).range(1.5F, 12F).step(0.001F))
                                                    .build())
                                            .option(Option
                                                    .<Float>createBuilder()
                                                    ...
                                                    .controller(floatOption -> new FloatSliderControllerBuilderImpl(floatOption).range(15F, 75F).step(1F))
                                                    .build())
                                            .option(Option
                                                    .<Boolean>createBuilder()
